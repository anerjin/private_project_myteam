...
async function main() {
   ...
   *
   * 네오의 브라우저는 서버 안에서 돕니다. 운영자가 「브라우저를 못 띄우는데?」
   * 라고 물었을 때 네오는 **「캡처해서 보여 드릴 수 있습니다」**라고 답했는데,
  ...
  /*
   * 이름은 화면과 프롬프트가 **같은 값**을 써야 합니다. 패널이 「네오」라고
   ...
   * 화면에 안 뜹니다」라고 못 박고 있었습니다. 그래서 네오가 운영자에게
